...
public class ElvMaleTrueAdapter extends BaseExpandableListAdapter {

    private  List<TopRankBean.MaleBean> maleTrue;
    private Activity context;



    public ElvMaleTrueAdapter(List<TopRankBean.MaleBean> maleTrue,Activity context){
        this.maleTrue=maleTrue;
        this.context=context;
    }


    public  List<TopRankBean.MaleBean> getList(){
        return maleTrue;
    }
